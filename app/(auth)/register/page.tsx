            ...
            {!isSuccess ? (
              ...
              >
                ...
                <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                  <div className="space-y-4  overflow-y-auto p-2 pr-2 custom-scrollbar">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        {...register('fullName')}
                        className={`h-11 bg-transparent border-gray-300 rounded-lg px-4 focus-visible:ring-1 focus-visible:ring-primary transition-all text-sm ${errors.fullName ? 'border-red-500 ring-1 ring-red-500/20' : ''}`}
                      />
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        {...register('email')}
                        className={`h-11 bg-transparent border-gray-300 rounded-lg px-4 focus-visible:ring-1 focus-visible:ring-primary transition-all text-sm ${errors.email ? 'border-red-500 ring-1 ring-red-500/20' : ''}`}
                      />
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        {...register('phone')}
                        className={`h-11 bg-transparent border-gray-300 rounded-lg px-4 focus-visible:ring-1 focus-visible:ring-primary transition-all text-sm ${errors.phone ? 'border-red-500 ring-1 ring-red-500/20' : ''}`}
                      />
                    ...
                    <div className="space-y-1.5 relative">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          {...register('password')}
                          className={`h-11 bg-transparent border-gray-300 rounded-lg px-4 pr-12 focus-visible:ring-1 focus-visible:ring-primary transition-all text-sm ${errors.password ? 'border-red-500 ring-1 ring-red-500/20' : ''}`}
                        />
                    ...
                    <div>
                      <div className='flex items-center space-x-2 py-2'>
                        <Checkbox id="terms" className="h-5 w-5 rounded-sm border-gray-300 data-[state=checked]:bg-primary data-[state=checked]:border-primary" onCheckedChange={(checked) => setValue('terms', !!checked, { shouldValidate: true })} />
                        <Label htmlFor="terms" className="text-[11px] font-medium text-gray-500 leading-tight cursor-pointer">
                          Agree to the <Link href="#" className="text-primary hover:underline">Terms & Privacy Policy</Link>
                        </Label>
                      </div>
                      <div className="">
                  ...
                  <Button type="submit" disabled={isLoading} className="w-full cursor-pointer h-12 bg-primary hover:bg-primary/90 text-white font-medium rounded-lg text-sm transition-all shadow-none active:scale-[0.98]">
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-500 font-medium tracking-tight">
                    Already have an account? <Link href="/login" className="text-gray-900 hover:text-primary font-bold transition-all underline underline-offset-4 decoration-gray-200">Sign In</Link>
                  </p>
                </div>
              </motion.div>
            ) : (
              ...
              >
                ...
                <Link href={`/verify-otp?email=${getValues('email')}`} className="w-full">
                  <Button className="w-full h-12 cursor-pointer bg-primary hover:bg-primary/90 text-white font-medium rounded-lg text-sm shadow-lg shadow-primary/20 active:scale-95 transition-all">
                    verify your email
                  </Button>
                </Link>
              </motion.div>
