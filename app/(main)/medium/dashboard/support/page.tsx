...
const ITEMS = [
  { icon: Info,           label: 'Help Center',       description: 'Browse FAQs and guides',        href: '#' },
  { icon: MessageSquare,  label: 'Live Chat Support',  description: 'Chat with our support team',    href: '#' },
  { icon: Mail,           label: 'Email Support',      description: 'support@avenirgo.com',          href: 'mailto:support@avenirgo.com' },
];
