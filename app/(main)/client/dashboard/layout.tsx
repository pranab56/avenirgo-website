...
import { Bell, Calendar, ClipboardList, CreditCard, HelpCircle, LogOut, Menu, Shield, X } from 'lucide-react';
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between px-4 pb-3 mb-1 border-b border-gray-100">
                <span className="font-bold text-sm text-[#1A1A1A]">Client Dashboard</span>
                <button
                  onClick={() => setMobileOpen(false)}
